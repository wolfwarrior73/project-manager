        ...
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
          ...
          <div>
            ...
            <div className="mt-1 flex items-start gap-2">
              ...
              <p className="text-gray500 text-xs dark:text-white">Private</p>
            </div>
          </div>
        </div>
        {/* NAVBAR LINKS */}
    ...
    <Link href={href} className="w-full">
      <div
        className={`relative flex cursor-pointer items-center gap-3 transition-colors hover:bg-gray-100 dark:hover:bg-gray-700 ${
          isActive
            ? "bg-gray-100 text-blue-600 dark:bg-gray-600 dark:text-white"
            : ""
